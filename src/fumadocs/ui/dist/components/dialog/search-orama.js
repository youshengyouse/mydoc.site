...
exports.default = OramaSearchDialog;
 ...
 */
function OramaSearchDialog(_a) {
    var client = _a.client, searchOptions = _a.searchOptions, _b = _a.tags, tags = _b === void 0 ? [] : _b, defaultTag = _a.defaultTag, _c = _a.showOrama, showOrama = _c === void 0 ? false : _c, _d = _a.allowClear, allowClear = _d === void 0 ? false : _d, index = _a.index, footer = _a.footer, _e = _a.links, links = _e === void 0 ? [] : _e, props = __rest(_a, ["client", "searchOptions", "tags", "defaultTag", "showOrama", "allowClear", "index", "footer", "links"]);
    var locale = (0, i18n_1.useI18n)().locale;
    var _f = (0, react_1.useState)(defaultTag), tag = _f[0], setTag = _f[1];
    var _g = (0, client_1.useDocsSearch)({
        type: 'orama-cloud',
        client: client,
        index: index,
...
function Label() {
    return (<a href="https://orama.com" rel="noreferrer noopener" className="ms-auto text-xs text-fd-muted-foreground">
