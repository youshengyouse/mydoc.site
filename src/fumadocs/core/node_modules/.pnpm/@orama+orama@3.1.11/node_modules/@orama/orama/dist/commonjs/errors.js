...
const allLanguages = languages_js_1.SUPPORTED_LANGUAGES.join('\n - ');
const errors = {
...
function createError(code, ...args) {
    const error = new Error((0, utils_js_1.sprintf)(errors[code] ?? `Unsupported Orama Error code: ${code}`, ...args));
    error.code = code;
