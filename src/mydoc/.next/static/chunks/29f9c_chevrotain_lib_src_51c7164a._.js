    ...
    try {
        ...
        if (e.message === complementErrorMessage) {
            if (ensureOptimizations) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$chevrotain$2b$utils$40$11$2e$0$2e$3$2f$node_modules$2f40$chevrotain$2f$utils$2f$lib$2f$src$2f$print$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRINT_WARNING"])("".concat(failedOptimizationPrefixMsg) + "	Unable to optimize: < ".concat(regExp.toString(), " >\n") + "\tComplement Sets cannot be automatically optimized.\n" + "\tThis will disable the lexer's first char optimizations.\n" + "\tSee: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#COMPLEMENT for details.");
            }
        } else {
            let msgSuffix = "";
            if (ensureOptimizations) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$chevrotain$2b$utils$40$11$2e$0$2e$3$2f$node_modules$2f40$chevrotain$2f$utils$2f$lib$2f$src$2f$print$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRINT_ERROR"])("".concat(failedOptimizationPrefixMsg, "\n") + "	Failed parsing: < ".concat(regExp.toString(), " >\n") + "	Using the @chevrotain/regexp-to-ast library\n" + "\tPlease open an issue at: https://github.com/chevrotain/chevrotain/issues" + msgSuffix);
        }
    }
    return [];
}
                ...
                if (typeof currTokType.PATTERN === "string") {
                    ...
                    if (currTokType.PATTERN.unicode) {
                        ...
                        if (options.ensureOptimizations) {
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$chevrotain$2b$utils$40$11$2e$0$2e$3$2f$node_modules$2f40$chevrotain$2f$utils$2f$lib$2f$src$2f$print$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRINT_ERROR"])("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$chevrotain$40$11$2e$0$2e$3$2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$scan$2f$reg_exp$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["failedOptimizationPrefixMsg"]) + "	Unable to analyze < ".concat(currTokType.PATTERN.toString(), " > pattern.\n") + "\tThe regexp unicode flag is not currently supported by the regexp-to-ast library.\n" + "\tThis will disable the lexer's first char optimizations.\n" + "\tFor details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNICODE_OPTIMIZE");
                        }
                    } else {
                    ...
                    if (options.ensureOptimizations) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$chevrotain$2b$utils$40$11$2e$0$2e$3$2f$node_modules$2f40$chevrotain$2f$utils$2f$lib$2f$src$2f$print$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRINT_ERROR"])("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$chevrotain$40$11$2e$0$2e$3$2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$scan$2f$reg_exp$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["failedOptimizationPrefixMsg"]) + "	TokenType: <".concat(currTokType.name, "> is using a custom token pattern without providing <start_chars_hint> parameter.\n") + "\tThis will disable the lexer's first char optimizations.\n" + "\tFor details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#CUSTOM_OPTIMIZE");
                    }
                    canBeOptimized = false;
                }
                return result;
...
function findUnreachablePatterns(tokenTypes) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lodash$2d$es$40$4$2e$17$2e$21$2f$node_modules$2f$lodash$2d$es$2f$forEach$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__forEach$3e$__["forEach"])(tokenTypes, (tokType, testIdx)=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lodash$2d$es$40$4$2e$17$2e$21$2f$node_modules$2f$lodash$2d$es$2f$forEach$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__forEach$3e$__["forEach"])(canBeTested, (param)=>{
...
const defaultParserErrorProvider = {
    buildMismatchTokenMessage (param) {
        ...
        const expectedMsg = hasLabel ? "--> ".concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$chevrotain$40$11$2e$0$2e$3$2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$scan$2f$tokens_public$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tokenLabel"])(expected), " <--") : "token of type --> ".concat(expected.name, " <--");
    ...
    buildEarlyExitMessage (param) {
        ...
        if (customUserDescription) {
            ...
            const nextValidTokenSequences = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lodash$2d$es$40$4$2e$17$2e$21$2f$node_modules$2f$lodash$2d$es$2f$map$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__map$3e$__["map"])(expectedIterationPaths, (currPath)=>"[".concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lodash$2d$es$40$4$2e$17$2e$21$2f$node_modules$2f$lodash$2d$es$2f$map$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__map$3e$__["map"])(currPath, (currTokenType)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$chevrotain$40$11$2e$0$2e$3$2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$scan$2f$tokens_public$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tokenLabel"])(currTokenType)).join(","), "]"));
...
function identifyProductionForDuplicates(prod) {
    return "".concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$chevrotain$2b$gast$40$11$2e$0$2e$3$2f$node_modules$2f40$chevrotain$2f$gast$2f$lib$2f$src$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProductionDslName"])(prod), "_#_").concat(prod.idx, "_#_").concat(getExtraProductionArgument(prod));
}
function getExtraProductionArgument(prod) {
    if (prod instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$chevrotain$2b$gast$40$11$2e$0$2e$3$2f$node_modules$2f40$chevrotain$2f$gast$2f$lib$2f$src$2f$model$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Terminal"]) {
        return prod.terminalType.name;
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lodash$2d$es$40$4$2e$17$2e$21$2f$node_modules$2f$lodash$2d$es$2f$forEach$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__forEach$3e$__["forEach"])(rules, (currRule)=>{
            this.TRACE_INIT("".concat(currRule.name, " Rule Lookahead"), ()=>{
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lodash$2d$es$40$4$2e$17$2e$21$2f$node_modules$2f$lodash$2d$es$2f$forEach$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__forEach$3e$__["forEach"])(alternation, (currProd)=>{
                    ...
                    this.TRACE_INIT("".concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$chevrotain$2b$gast$40$11$2e$0$2e$3$2f$node_modules$2f40$chevrotain$2f$gast$2f$lib$2f$src$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProductionDslName"])(currProd)).concat(prodIdx), ()=>{
...
class RecognizerApi {
    ...
    RULE(name, implementation) {
        let config = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$chevrotain$40$11$2e$0$2e$3$2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$parse$2f$parser$2f$parser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_RULE_CONFIG"];
...
function createSyntaxDiagramsCode(grammar) {
    let { resourceBase = "https://unpkg.com/chevrotain@".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$chevrotain$40$11$2e$0$2e$3$2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$version$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VERSION"], "/diagrams/"), css = "https://unpkg.com/chevrotain@".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$chevrotain$40$11$2e$0$2e$3$2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$version$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VERSION"], "/diagrams/diagrams.css") } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
