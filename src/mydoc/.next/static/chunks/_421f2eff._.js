...
"[project]/packages/openapi/dist/ui/components/dialog.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.k.register(_c, "DialogOverlay$React.forwardRef");
...
"[project]/packages/openapi/dist/playground/auth/oauth-dialog.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_$40$babel$2b$core$40$7$2e$28$2e$3_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_babel$2d$plugin$2d$macros$40$3$2e$1$2e$0_react$2d$dom$40$1_j6u7u72df46a4ml46cu3en6mca$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/next@15.5.0_@babel+core@7.28.3_@opentelemetry+api@1.9.0_babel-plugin-macros@3.1.0_react-dom@1_j6u7u72df46a4ml46cu3en6mca/node_modules/next/dist/compiled/react/jsx-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$openapi$2f$dist$2f$ui$2f$components$2f$dialog$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/openapi/dist/ui/components/dialog.js [app-client] (ecmascript)");
...
function OauthDialog(param) {
    let { scheme, scopes, setToken, children, open, setOpen } = param;
    _s();
    ...
    const authCodeCallback = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$openapi$2f$dist$2f$utils$2f$use$2d$query$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        "OauthDialog.useQuery[authCodeCallback]": async (code, state)=>{
            ...
            setToken("".concat(token_type, " ").concat(access_token));
            setOpen(false);
        }
    }["OauthDialog.useQuery[authCodeCallback]"]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_$40$babel$2b$core$40$7$2e$28$2e$3_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_babel$2d$plugin$2d$macros$40$3$2e$1$2e$0_react$2d$dom$40$1_j6u7u72df46a4ml46cu3en6mca$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OauthDialog.useEffect": ()=>{
            ...
            if (scheme.flows.implicit && window.location.hash.length > 1) {
                ...
                var _params_get;
                const type = (_params_get = params.get('token_type')) !== null && _params_get !== void 0 ? _params_get : 'Bearer';
                if (state && token) {
                    const parsedState = JSON.parse(state);
                    form.setValue('clientId', parsedState.client_id);
                    setToken("".concat(type, " ").concat(token));
                    window.history.replaceState(null, '', window.location.pathname);
                }
            }
    ...
    const authorize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$openapi$2f$dist$2f$utils$2f$use$2d$query$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        "OauthDialog.useQuery[authorize]": async (values)=>{
            if (type === 'implicit') {
                ...
                window.location.replace("".concat(value.authorizationUrl, "?").concat(params.toString()));
                return;
            }
    ...
    }["OauthDialog.useQuery[authorize]"]);
    const onSubmit = form.handleSubmit((values)=>{
        return authorize.start(values);
    });
    const isLoading = authorize.isLoading || authCodeCallback.isLoading;
    var _authCodeCallback_error;
    const error = (_authCodeCallback_error = authCodeCallback.error) !== null && _authCodeCallback_error !== void 0 ? _authCodeCallback_error : authorize.error;
                ...
                children: [
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_$40$babel$2b$core$40$7$2e$28$2e$3_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_babel$2d$plugin$2d$macros$40$3$2e$1$2e$0_react$2d$dom$40$1_j6u7u72df46a4ml46cu3en6mca$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("form", {
                        ...
                        children: [
                            ...
                            (type === 'authorizationCode' || type === 'clientCredentials') && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_$40$babel$2b$core$40$7$2e$28$2e$3_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_babel$2d$plugin$2d$macros$40$3$2e$1$2e$0_react$2d$dom$40$1_j6u7u72df46a4ml46cu3en6mca$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("fieldset", {
                                className: "flex flex-col gap-1.5",
                                children: [
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$0_$40$babel$2b$core$40$7$2e$28$2e$3_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_babel$2d$plugin$2d$macros$40$3$2e$1$2e$0_react$2d$dom$40$1_j6u7u72df46a4ml46cu3en6mca$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("label", {
...
_s(OauthDialog, "uo4yPZweNavC8K56FFCmM9dY4eg=", false, function() {
    return [
...
_c = OauthDialog;
const OauthDialogTrigger = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$openapi$2f$dist$2f$ui$2f$components$2f$dialog$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogTrigger"];
var _c;
__turbopack_context__.k.register(_c, "OauthDialog");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_421f2eff._.js.map