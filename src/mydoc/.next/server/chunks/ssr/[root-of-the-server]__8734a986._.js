...
"[project]/packages/mdx/dist/mdx-options-3NB74EMB.js [app-rsc] (ecmascript, async loader)", ((__turbopack_context__) => {

__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/packages_mdx_dist_mdx-options-3NB74EMB_c72d7e07.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
        return parentImport("[project]/packages/mdx/dist/mdx-options-3NB74EMB.js [app-rsc] (ecmascript)");
    });
});
}),
...
__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/[externals]_shiki_engine_oniguruma_f5b30f3f._.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
...
__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/[externals]_shiki_wasm_ac43d9bf._.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
...
__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/[externals]_shiki_engine_javascript_1fc3cfdb._.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
        return parentImport("[externals]/shiki/engine/javascript [external] (shiki/engine/javascript, esm_import)");
    });
});
}),
"[externals]/oxc-transform [external] (oxc-transform, cjs, async loader)", ((__turbopack_context__) => {

__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/[externals]_oxc-transform_5a075b92._.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
        return parentImport("[externals]/oxc-transform [external] (oxc-transform, cjs)");
    });
});
}),
];